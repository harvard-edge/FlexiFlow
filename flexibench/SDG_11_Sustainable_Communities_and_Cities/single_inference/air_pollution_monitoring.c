...
int main() {
  unsigned char pm25 = PM25;
  unsigned char pm10 = PM10;
  unsigned char no = NO;
  unsigned char no2 = NO2;
  unsigned char nox = NOx;
  unsigned char nh3 = NH3;
  unsigned char co = CO;
  unsigned char so2 = SO2;
  unsigned char o3 = O3;
  unsigned char benzene = Benzene;
  unsigned char toluene = Toluene;
  unsigned char xylene = Xylene;

  result = boosted_predict(
