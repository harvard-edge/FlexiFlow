...
"""
            ...
            header_file.write(f"#define VERIFICATION 0b{row[1]}\n")
            header_file.write(f"const volatile char Golden_Reference_Prediction = {row[0]};")
...
""")
            ...
            header_file.write("const int RFID_Input_Signal [Num_Data_Points] = {\n")
