...
int Read_Values_Run_Neural_Network() {

    // Run inference for all samples in the vectors and return the number of correct predictions
    int correct = 0;
    for (int i = 0; i < NUM_SAMPLES; i++) {
        signed char feature0 = Feature_0_Vector[i];
        signed char feature1 = Feature_1_Vector[i];
        signed char feature2 = Feature_2_Vector[i];
        signed char feature3 = Feature_3_Vector[i];
        signed char feature4 = Feature_4_Vector[i];
        signed char feature5 = Feature_5_Vector[i];
        signed char feature6 = Feature_6_Vector[i];
        signed char feature7 = Feature_7_Vector[i];
        signed char feature8 = Feature_8_Vector[i];
        signed char feature9 = Feature_9_Vector[i];
        signed char feature10 = Feature_10_Vector[i];
        signed char feature11 = Feature_11_Vector[i];
        signed char feature12 = Feature_12_Vector[i];
        signed char feature13 = Feature_13_Vector[i];
        signed char feature14 = Feature_14_Vector[i];
        signed char feature15 = Feature_15_Vector[i];
        signed char feature16 = Feature_16_Vector[i];
        signed char feature17 = Feature_17_Vector[i];
        signed char feature18 = Feature_18_Vector[i];
        signed char feature19 = Feature_19_Vector[i];
        signed char feature20 = Feature_20_Vector[i];
        signed char feature21 = Feature_21_Vector[i];
        signed char feature22 = Feature_22_Vector[i];
        signed char feature23 = Feature_23_Vector[i];
        signed char feature24 = Feature_24_Vector[i];
        signed char feature25 = Feature_25_Vector[i];
        signed char feature26 = Feature_26_Vector[i];
        signed char feature27 = Feature_27_Vector[i];
        signed char feature28 = Feature_28_Vector[i];
        signed char feature29 = Feature_29_Vector[i];
        signed char feature30 = Feature_30_Vector[i];
        signed char feature31 = Feature_31_Vector[i];
        signed char feature32 = Feature_32_Vector[i];
